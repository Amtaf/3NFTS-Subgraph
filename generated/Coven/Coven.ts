...
export class Coven__royaltyInfoResult {
  value0: Address;
  value1: BigInt;
...
export class Coven extends ethereum.SmartContract {
  static bind(address: Address): Coven {
    return new Coven("Coven", address);
  }
  ...
  royaltyInfo(tokenId: BigInt, salePrice: BigInt): Coven__royaltyInfoResult {
    let result = super.call(
      "royaltyInfo",
    ...
    return new Coven__royaltyInfoResult(
      result[0].toAddress(),
      result[1].toBigInt()
    );
  }
  ...
  try_royaltyInfo(
    tokenId: BigInt,
    salePrice: BigInt
  ): ethereum.CallResult<Coven__royaltyInfoResult> {
    let result = super.tryCall(
      "royaltyInfo",
      "royaltyInfo(uint256,uint256):(address,uint256)",
      [
    ...
    return ethereum.CallResult.fromValue(
      new Coven__royaltyInfoResult(value[0].toAddress(), value[1].toBigInt())
    );
  }
